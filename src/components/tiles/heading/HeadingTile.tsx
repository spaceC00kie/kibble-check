...
export const HeadingTile = () => {
  return (
    ...
    >
      ...
      <p className="m-3 rounded-md border border-yellow-500 border-opacity-50 bg-red-900 bg-opacity-70 p-2 text-lg font-bold text-yellow-50 sm:ml-14 sm:w-1/2 sm:text-2xl">
